...
Optionally, it provides an [opinionated framework](https://github.com/inoutgg/inertia/tree/main/tree/inertiaframe) for building Inertia.js applications on top of the `http.ServeMux` compatible routers.
